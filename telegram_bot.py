# -*- coding: utf-8 -*-
"""
Created on Thu Dec 23 13:01:12 2021
...
def chat(message):      
    ...
    if any(x in txt.lower() for x in ["thank","thx","cool"]):          
        ...
        #if str(message.chat.username) is "none" else "yo " + str(message.chat.username)      
    else:          
...
def webhook():          
    bot.remove_webhook()          
    bot.set_webhook(url='https://botdatareminder.herokuapp.com/' + config.telegram_key)          
